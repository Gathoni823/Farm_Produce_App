package com.example.farmproduceapp.ui.theme.screens.login
...
import com.example.farmproduceapp.navigation.ROUTE_REGISTER
...
fun LoginScreen(navController: NavController) {
    ...
    Box(
        modifier = Modifier
            .fillMaxSize()
            .background(Color.Cyan) // Apply magenta background color here
    ) {
