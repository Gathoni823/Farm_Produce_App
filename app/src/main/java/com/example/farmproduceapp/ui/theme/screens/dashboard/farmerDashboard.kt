...
import com.example.farmproduceapp.navigation.ROUTE_ADD_PRODUCE
                    ...
                    item {
                        ...
                        Card(
                            modifier = Modifier
                                .fillMaxWidth()
                                .clickable {
                                    navController.navigate(ROUTE_ADD_PRODUCE)
                                },
                            ...
                            Column(
                                ...
                                Image(
                                    ...
                                    contentDescription = "Add Produce",
                                    modifier = Modifier
                                        .height(200.dp)
                                        .fillMaxWidth(),
                    ...
                    item {
                        ...
                        Card(
                            ...
                            Column(
                                ...
                                Image(
                                    painter = painterResource(id = R.drawable.maize),
                                    contentDescription = "View Produce",
                                    modifier = Modifier
                                        .height(200.dp)
                                        .fillMaxWidth(),
                                    contentScale = ContentScale.Crop
                    ...
                    item {
                        ...
                        Card(
                            modifier = Modifier
                                .fillMaxWidth()
                                .clickable {
                                    navController.navigate(ROUTE_EDIT_PRODUCE)
                                },
                            shape = RoundedCornerShape(20.dp),
                            elevation = CardDefaults.cardElevation(10.dp)
                        ) {
                            Column(
                                ...
                                Image(
                                    painter = painterResource(id = R.drawable.maize),
                                    contentDescription = "Update Produce",
                                    modifier = Modifier
                                        .height(200.dp)
                                        .fillMaxWidth(),
                                    contentScale = ContentScale.Crop
...
fun FarmerDashboardPreview() {
    FarmerDashboard(rememberNavController())
}
